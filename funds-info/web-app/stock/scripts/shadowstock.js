    ...
    var _shadowStock = {},
        ...
        initColumnEngines = function () {
            ...
            _columnEngines[_appSettings.fullNameColumnId] = {
                ...
                getText: function (data) {
                    if (this._text == undefined) {
                        this._text = _formatString('{2} <a title="新浪股票" href="http://biz.finance.sina.com.cn/suggest/lookup_n.php?q={0}" target="_blank">{1}</a>|<a title="BS点" href="http://www.iqaunt.com/s/{0}" target="_blank">BS</a>',
